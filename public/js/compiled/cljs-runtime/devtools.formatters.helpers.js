...
var G__28525 = devtools.prefs.pref(v);
v = G__28525;
continue;
} else {
return v;
...
}catch (e28397){var _e__27776__auto__ = e28397;
return false;
}})();
...
}catch (e28429){var _e__27776__auto__ = e28429;
return false;
}})();
...
}catch (e28439){var _e__27776__auto__ = e28439;
return false;
}}
}
});
...
var vec__28474 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28474,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28474,(1),null);
...
return cljs.core.some((function (p1__28485_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28485_SHARP_);
}),template);
});
