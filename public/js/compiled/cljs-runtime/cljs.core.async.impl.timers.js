...
var i_32842 = (0);
while(true){
if((i_32842 < arr.length)){
(arr[i_32842] = null);

var G__32843 = (i_32842 + (1));
i_32842 = G__32843;
continue;
} else {
}
...
var i_32854 = (self__.level + (1));
while(true){
if((i_32854 <= (new_level + (1)))){
(update[i_32854] = self__.header);

var G__32855 = (i_32854 + (1));
i_32854 = G__32855;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_32857 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32857[i]));
} else {
x__$2.forward.push((((i < links_32857.length))?(links_32857[i]):null));
}

if((i < links_32857.length)){
(links_32857[i] = x__$2);
} else {
links_32857.push(x__$2);
}
...
var i_32860 = (0);
while(true){
if((i_32860 <= self__.level)){
var links_32861 = (update[i_32860]).forward;
if((x__$1 === (((i_32860 < links_32861.length))?(links_32861[i_32860]):null))){
(links_32861[i_32860] = (x__$1.forward[i_32860]));

var G__32862 = (i_32860 + (1));
i_32860 = G__32862;
continue;
} else {
var G__32863 = (i_32860 + (1));
i_32860 = G__32863;
continue;
}
} else {
...
var G__32866 = nx;
var G__32867 = (level__$1 - (1));
x = G__32866;
level__$1 = G__32867;
continue;
} else {
var G__32868 = x;
var G__32869 = (level__$1 - (1));
x = G__32868;
level__$1 = G__32869;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__32874 = nx;
var G__32875 = (level__$1 - (1));
x = G__32874;
level__$1 = G__32875;
continue;
} else {
var G__32876 = x;
var G__32877 = (level__$1 - (1));
x = G__32876;
level__$1 = G__32877;
continue;
}
