...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28534){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28535,G__28536,seq28534__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28546_SHARP_){
return (!((cljs.core.meta(p1__28546_SHARP_) == null)));
})))){
...
var map__28560 = opts;
var map__28560__$1 = cljs.core.__destructure_map(map__28560);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28560__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28561){var _e__27776__auto__ = e28561;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e28566){var _e__27776__auto__ = e28566;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28574 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28575 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28575);

try{var map__28580 = opts;
var map__28580__$1 = cljs.core.__destructure_map(map__28580);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28580__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28574);
}});
...
var temp__5751__auto___28600 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___28600)){
var managed_print_level_28601 = temp__5751__auto___28600;
var _STAR_print_level_STAR__orig_val__28586_28602 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28587_28603 = managed_print_level_28601;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28587_28603);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28581_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28581_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28586_28602);
}} else {
job_fn();
}
