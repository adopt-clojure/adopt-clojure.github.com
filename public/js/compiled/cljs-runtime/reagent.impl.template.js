...
var G__38346 = o;
(G__38346[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__38693__i < G__38693__a.length) {G__38693__a[G__38693__i] = arguments[G__38693__i + 0]; ++G__38693__i;}
  args = new cljs.core.IndexedSeq(G__38693__a,0,null);
} 
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__38361){
var map__38362 = p__38361;
var map__38362__$1 = cljs.core.__destructure_map(map__38362);
var props = map__38362__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38362__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__38363){
var map__38364 = p__38363;
var map__38364__$1 = cljs.core.__destructure_map(map__38364);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38364__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__38389){
var map__38390 = p__38389;
var map__38390__$1 = cljs.core.__destructure_map(map__38390);
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38390__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38390__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__38406 = jsprops;
(G__38406["defaultValue"] = value);

(G__38406["onChange"] = (function (p1__38372_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__38372_SHARP_);
}));
...
var vec__38465 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38465,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38465,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38465,(2),null);
...
var jsprops = ({"argv": v});
var temp__5757__auto___38701 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___38701 == null)){
} else {
var key_38702 = temp__5757__auto___38701;
(jsprops["key"] = key_38702);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__38675){
var map__38676 = p__38675;
var map__38676__$1 = cljs.core.__destructure_map(map__38676);
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38676__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__38677 = reagent.impl.template.__GT_NativeWrapper();
(G__38677["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__38678 = wrapped;
(G__38678["syntheticInput"] = true);

return G__38678;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__38679 = wrapped__$1;
(G__38679["syntheticOnChange"] = on_change);

return G__38679;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__38680 = wrapped__$2;
(G__38680["syntheticOnUpdate"] = on_update);
...
var len__4864__auto___38706 = arguments.length;
var i__4865__auto___38707 = (0);
while(true){
if((i__4865__auto___38707 < len__4864__auto___38706)){
args__4870__auto__.push((arguments[i__4865__auto___38707]));

var G__38708 = (i__4865__auto___38707 + (1));
i__4865__auto___38707 = G__38708;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38684){
var G__38685 = cljs.core.first(seq38684);
var seq38684__$1 = cljs.core.next(seq38684);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38685,seq38684__$1);
}));
...
break;
default:
var G__38711 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__38711;
continue;
...
var n__4741__auto___38712 = a.length;
var i_38713 = (0);
while(true){
if((i_38713 < n__4741__auto___38712)){
(a[i_38713] = reagent.impl.template.as_element((a[i_38713])));

var G__38714 = (i_38713 + (1));
i_38713 = G__38714;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4741__auto___38715 = a.length;
var i_38716 = (0);
while(true){
if((i_38716 < n__4741__auto___38715)){
var val_38717 = (a[i_38716]);
if(((cljs.core.vector_QMARK_(val_38717)) && ((reagent.impl.template.key_from_vec(val_38717) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_38716] = reagent.impl.template.as_element(val_38717));

var G__38718 = (i_38716 + (1));
i_38716 = G__38718;
continue;
} else {
}
...
var ctx = ({});
var vec__38688 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38688,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38688,(1),null);
...
var G__38691 = (cljs.core.count(argv) - first_child);
switch (G__38691) {
case (0):
