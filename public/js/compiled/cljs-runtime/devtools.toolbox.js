...
if((typeof devtools !== 'undefined') && (typeof devtools.toolbox !== 'undefined') && (typeof devtools.toolbox.t_devtools$toolbox30713 !== 'undefined')){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox30713 = (function (obj,header,style,tag,meta30714){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
(devtools.toolbox.t_devtools$toolbox30713.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_30715,meta30714__$1){
var self__ = this;
var _30715__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox30713(self__.obj,self__.header,self__.style,self__.tag,meta30714__$1));
}));

(devtools.toolbox.t_devtools$toolbox30713.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_30715){
var self__ = this;
var _30715__$1 = this;
return self__.meta30714;
}));

(devtools.toolbox.t_devtools$toolbox30713.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox30713.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox30713.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox30713.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox30713.getBasis = (function (){
...
(devtools.toolbox.t_devtools$toolbox30713.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox30713.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox30713");

(devtools.toolbox.t_devtools$toolbox30713.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"devtools.toolbox/t_devtools$toolbox30713");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox30713.
 */
devtools.toolbox.__GT_t_devtools$toolbox30713 = (function devtools$toolbox$__GT_t_devtools$toolbox30713(obj__$1,header__$1,style__$1,tag__$1,meta30714){
return (new devtools.toolbox.t_devtools$toolbox30713(obj__$1,header__$1,style__$1,tag__$1,meta30714));
});

}

return (new devtools.toolbox.t_devtools$toolbox30713(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
