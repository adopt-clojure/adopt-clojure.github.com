...
var vec__37660 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__37662;
var parts = seq__37661__$1;
...
var self__ = this;
var self__ = this;
var G__37666 = (arguments.length - (1));
switch (G__37666) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args37664){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args37664)));
}));
...
var _STAR_always_update_STAR__orig_val__37706 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__37707 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__37707);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__37706);
}} else {
